...
[TestClass]
public class AsyncOrderControllerTests
{
    [TestMethod]
    public void CanCreateOrderWithCorrectModel()
    {
        ...
        var productRepository = new Mock<IAsyncRepository<Product>>();
        var customerRepository = new Mock<IAsyncRepository<Customer>>();
        ...
        orderRepository.Verify(r => r.AddAsync(It.IsAny<Order>()), Times.AtLeastOnce());
    }
}
